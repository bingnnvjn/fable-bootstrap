...
##
TERMUX_APP__PACKAGE_NAME="com.gph.fable"
...
# Fable fork: the bootstrap is consumed by termux-app v0.119.0-beta.3
# based fable-app, which expects the second stage script at
# `$TERMUX_PREFIX/etc/termux/bootstrap/termux-bootstrap-second-stage.sh`.
# Override the upstream `second-stage` layout accordingly.
TERMUX_BOOTSTRAP__BOOTSTRAP_SECOND_STAGE_DIR="$TERMUX__PREFIX__ETC_DIR/$TERMUX__INTERNAL_NAME/bootstrap"
